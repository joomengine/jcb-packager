...
class Item << (F,LightGreen) >> #RoyalBlue {
  ...
  # getEncodingTypeLabel(int $value) : string
  # getFieldType(object $item) : ?string
}
...
note right of Item::getEncodingTypeLabel
...
note right of Item::getFieldType
...
> Simply use this SPK:
```
Super---c315c264_0a94_4a06_98e4_3acdf11ac7f5---Power
```
