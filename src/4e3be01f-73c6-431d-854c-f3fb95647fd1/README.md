...
class Config  #Gold {
  ...
  # getRepositorycoreorganisation() : string
  # getRepositoryinitrepos() : array
...
note right of Config::getRepositorycoreorganisation
...
note right of Config::getRepositoryinitrepos
...
> Simply use this SPK:
```
Super---4e3be01f_73c6_431d_854c_f3fb95647fd1---Power
```
