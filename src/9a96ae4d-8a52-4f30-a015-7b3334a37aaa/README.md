...
class Set << (F,LightGreen) >> #RoyalBlue {
  # mapItemValue_view_table_main(object $item, array $power) : void
}

note right of Set::mapItemValue_view_table_main
...
> Simply use this SPK:
```
Super---9a96ae4d_8a52_4f30_a015_7b3334a37aaa---Power
```
