### JCB! Power
# interface ResolverInterface (Details)
> namespace: **VDM\Joomla\Interfaces\Remote\Dependency**

```uml
@startuml

interface ResolverInterface  #Lavender {
  + extract(object $item) : ?array
}

note right of ResolverInterface::extract
...
> Simply use this SPK:
```
Super---40cacef9_c4be_40ac_95e4_0925b980731d---Power
```
