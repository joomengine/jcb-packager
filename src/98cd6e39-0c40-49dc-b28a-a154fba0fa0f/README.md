### JCB! Power
# trait SetDependenciesTrait (Details)
> namespace: **VDM\Joomla\Componentbuilder\Remote**

```uml
@startuml

class SetDependenciesTrait << (T,Orange) >> #Turquoise {
  # setDependencies(object $power) : void
}

note right of SetDependenciesTrait::setDependencies
...
> Simply use this SPK:
```
Super---98cd6e39_0c40_49dc_b28a_a154fba0fa0f---Power
```
